...
{
    public partial class FrmEstrellaMultiple : Form
    {
        private EstrellaMultiple objEstrella = new EstrellaMultiple();
        public FrmEstrellaMultiple()
        {
            InitializeComponent();
            this.KeyPreview = true;
        }

        private void FrmEstrellaMultiple_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.Up:
